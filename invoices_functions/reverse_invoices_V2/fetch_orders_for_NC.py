...
def send_email_with_attachments(sender_email, sender_password, to_recipients, cc_recipients, subject, body,
                                attachment_paths):
...
def init_process(start_date, end_date, version_files=''):
    ...
    cc_recipients = ['greta@somos-reyes.com', 'alex@wonderbrands.co', 'will@wonderbrands.co', 'eric@wonderbrands.co',
                     'sebastian@wonderbrands.co', 'sergio@wonderbrands.co']
    ...
    send_email_with_attachments(sender_email, sender_password, recipients, cc_recipients, subject, body,
                                attachment_paths)
